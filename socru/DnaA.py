...
class DnaA:
    def __init__(self, dnaa_fasta, directory_of_fasta_files, threads, min_bit_score = 100, min_alignment_length = 1000):
    ...
    def find_dnaa(self):
        blastdb = Database(self.directory_of_fasta_files)
        blast = Blast(blastdb.db_prefix, self.threads, task = 'blastn',  word_size = 11)
